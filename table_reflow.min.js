...
a(this).data("cells");var b=a(this).data("colstart"),c=d.not(this).filter("thead th").length&&" ui-table-cell-label-top",g=a(this).text();if(""!==g)if(c){var f=parseInt(a(this).attr("colspan"),10),h="";f&&(h="td:nth-child("+f+"n + "+b+")");d.filter(h).each(function(){var b=a(this);b.html('<div class="ui-table-cell-content">'+b.html()+"</div>").prepend("<div class='"+e.classes.cellLabels+c+"'>"+g+"</div>")})}else d.each(function(){var b=a(this);b.html('<div class="ui-table-cell-content">'+b.html()+
"</div>").prepend("<div class='"+e.classes.cellLabels+"'>"+g+"</div>")})}))}};a.fn.reflowTable=function(b){return this.each(function(){a.data(this,"mailor_reflowTable")||a.data(this,"mailor_reflowTable",new h(this,b))})}})(jQuery,window,document);